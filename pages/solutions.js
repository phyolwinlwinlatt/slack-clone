...
const cards = [
  {
    image: phone,
    type: "Customer Story",
    title: "How Zendesk delivers exceptional customer service with Slack",
    linkText: "Read more",
  },
  {
    image: legs,
    type: "Customer Story",
    title: "Mission-critical sales work at Lyft Business",
    linkText: "Read story",
  },
  {
    image: paper,
    type: "Customer Story",
    title: "Nine’s publishing division breaks news faster with Slack",
    linkText: "Read story",
  },
  {
    image: working,
      ...
      <div className={container}>
        <section className={sectionIntro}>
          ...
          <div>
            <button
              type="button"
              className="btn btn--lg btn--primary-contained u-mr-sm"
            >
              Try Slack
            </button>
            <button type="button" className="btn btn--lg btn--primary-outlined">
              Contact Sale
            </button>
          </div>
          <figure className={iconGreeting}>
            <Image
              src="/greeting.png"
              width={90}
              height={60}
          ...
          <figure className={iconDuck}>
            <Image src="/duck.png" width={90} height={60} alt="duck icon" />
          </figure>
          <figure className={iconHands}>
            <Image src="/hands.png" width={90} height={60} alt="hands icon" />
          </figure>
          <figure className={iconTick}>
            <Image
              src="/tick.png"
              className={iconTick}
              width={90}
          ...
          <figure className={iconCelebrate}>
            <Image
              src="/celebrate.png"
              className={iconCelebrate}
              width={80}
              height={50}
              alt="celebrate icon"
            />
        ...
        <div className="u-bg-grey-light">
          <div className="u-max-width-85">
            <section className={sectionSolutions}>
              <div className={teams}>
                <div className={teams__text}>
                  <h2 className="heading-2 heading-2--black u-mb-md">
                    For all kinds of teams
                  </h2>
                  <p className="text text--black">
                    No matter which branch of the org chart you call home, you
                    can keep your team’s communication organized and efficient
                    in Slack.
                  </p>
                </div>
                <div className={teams__imgBox}>
                  <Image
                    src="/speaker.png"
                    alt="Speaker"
                    width={500}
              ...
              <div className={applications}>
                <div className={[iconCard, engineering].join(" ")}>
                  <svg
                    width="48"
                    height="48"
                    viewBox="0 0 48 48"
                ...
                <div className={[iconCard, customerService].join(" ")}>
                  ...
                  <p className="text text--black">
                    Keep your customers happy by getting answers and reaching
                    resolutions with help from your entire organization.
                  </p>
                </div>
                <div className={[iconCard, sales].join(" ")}>
                  <svg
                    fill="none"
                    height="48"
                    viewBox="0 0 48 48"
                ...
                <div className={[iconCard, humanResources].join(" ")}>
                  <svg
                    fill="none"
                    height="44"
                    viewBox="0 0 48 44"
                ...
                <div className={[iconCard, marketing].join(" ")}>
                  <svg
                    fill="none"
                    height="48"
                    viewBox="0 0 48 48"
                ...
                <div className={[iconCard, security].join(" ")}>
                  ...
                  <h3 className="heading-3 heading-3--black">Security</h3>
                </div>
              </div>
              <div className={companies}>
                <div className={companies__imgBox}>
                  <Image
                    src="/companies.jpeg"
                    alt="At all kinds of companies"
                    width={400}
                    height={320}
                  />
                </div>
                <div className={companies__text}>
                  ...
                  <p className="text text--black">
                    Slack works for a wide range of companies—even ones with
                    specialized workflows or strict compliance requirements.
                  </p>
                </div>
              </div>
              <div className={services}>
                <div className={iconCard}>
                  ...
                  <h3 className="heading-3 heading-3--black">Education</h3>
                  <p className="text text--black">
                    Engage students and connect your entire campus with a
                ...
                <div className={iconCard}>
                  ...
                  <h3 className="heading-3 heading-3--black">Media</h3>
                  <p className="text text--black">
                    Expedite production, communicate openly and automate your
                    publishing process in your new newsroom.
                  </p>
                </div>
                <div className={iconCard}>
                  <svg
                  ...
                  >
                    <path
                      d="M45.24 24.12H39.696C39.696 24.048 39.696 23.976 39.696 23.904L34.248 6.85201C34.1418 6.505 33.9671 6.18281 33.7342 5.90454C33.5013 5.62628 33.2149 5.39758 32.892 5.23201C32.2471 4.89855 31.4964 4.83383 30.804 5.05201L2.17199 14.124C1.47793 14.3471 0.900354 14.8358 0.565356 15.4833C0.230359 16.1308 0.165156 16.8846 0.383986 17.58L5.78399 34.632C5.9614 35.1873 6.31007 35.6722 6.78002 36.0171C7.24996 36.362 7.81705 36.5492 8.39999 36.552C8.68493 36.5493 8.96794 36.5048 9.23999 36.42L12.468 35.4V44.76C12.468 45.4888 12.7575 46.1878 13.2729 46.7031C13.7882 47.2185 14.4872 47.508 15.216 47.508H45.216C45.5794 47.5112 45.9399 47.4425 46.2768 47.306C46.6136 47.1694 46.9202 46.9677 47.1789 46.7124C47.4376 46.4571 47.6433 46.1531 47.7842 45.8181C47.9251 45.4831 47.9984 45.1235 48 44.76V26.868C47.9968 26.1381 47.7046 25.4392 47.1874 24.9242C46.6701 24.4091 45.9699 24.12 45.24 24.12V24.12ZM31.464 7.99201L32.496 11.256L4.35599 20.172L3.32399 16.908L31.464 7.99201ZM8.56799 33.48L5.86799 24.936L34.008 16.02L36.576 24.12H15.216C14.4872 24.12 13.7882 24.4095 13.2729 24.9249C12.7575 25.4402 12.468 26.1392 12.468 26.868V32.244L8.56799 33.48ZM44.988 44.508H15.468V27.12H44.988V44.508Z"
                      fill="#1D1C1D"
                    ></path>
                    <path
                      d="M42.072 39.096H17.856V42.096H42.072V39.096Z"
                      fill="#1D1C1D"
                    ></path>
                    <path
                      d="M22.884 30.624H18.156V35.352H22.884V30.624Z"
                      fill="#1D1C1D"
                    ></path>
                  </svg>
                  <h3 className="heading-3 heading-3--black">
                  ...
                  <p className="text text--black">
                    Connect your systems with your internal and external teams
                    to digitally transform your organization.
                  </p>
                </div>
              </div>
              <div className={things}>
                <div className={things__text}>
                  <h2 className="heading-2 heading-2--black u-mb-md">
                    Doing Amazing Things
                  </h2>
                  <p className="text text--black">
                    Like a many-trick pony, Slack can adapt to fit the needs of
                    just about anything you need to do at work.
                  </p>
                </div>
                <div className={things__imgBox}>
                  <Image
                    src="/amazing-things.jpeg"
                    alt="Amazing Things"
                    width={700}
                    height={600}
                  />
              ...
              <div className={tools}>
                ...
                <div className={iconCard}>
                  ...
                  >
                    <path
                      d="M38.8518 10.6165C38.8518 10.5035 38.8518 10.3906 38.7388 10.2776V10.1647C38.6259 10.0518 38.6259 9.82588 38.5129 9.71294L29.1388 0.338824C29.0259 0.225882 28.9129 0.112941 28.6871 0.112941H28.5741C28.4612 0 28.3482 0 28.2353 0H28.1224H11.1812C8.47059 0 6.32471 2.14588 6.32471 4.74353V5.98588H4.74353C2.14588 6.09882 0 8.24471 0 10.8424V43.1435C0 45.7412 2.14588 47.8871 4.74353 47.8871H27.6706C30.2682 47.8871 32.4141 45.7412 32.4141 43.1435V41.9012H33.8824C36.48 41.9012 38.6259 39.7553 38.6259 37.1577L38.8518 10.6165C38.8518 10.7294 38.8518 10.7294 38.8518 10.6165ZM33.9953 9.37412H29.4776V4.85647L33.9953 9.37412ZM29.7035 43.1435C29.7035 44.2729 28.8 45.1765 27.6706 45.1765H4.74353C3.61412 45.1765 2.71059 44.2729 2.71059 43.1435V10.8424C2.71059 9.71294 3.61412 8.80941 4.74353 8.80941H6.21176V37.0447C6.21176 39.6424 8.35765 41.7882 10.9553 41.7882H29.5906V43.1435H29.7035ZM34.1082 39.0776H11.0682C9.93882 39.0776 9.03529 38.1741 9.03529 37.0447V4.74353C9.03529 3.61412 9.93882 2.71059 11.0682 2.71059H26.6541V10.6165C26.6541 11.4071 27.3318 11.9718 28.0094 11.9718H35.9153V36.9318C36.0282 38.1741 35.1247 39.0776 34.1082 39.0776Z"
                      fill="#1D1C1D"
                    ></path>
                    <path
                      d="M30.0423 17.28H15.1341C14.3435 17.28 13.7788 17.9576 13.7788 18.6353C13.7788 19.3129 14.4565 19.9906 15.1341 19.9906H30.0423C30.8329 19.9906 31.3976 19.3129 31.3976 18.6353C31.3976 17.9576 30.8329 17.28 30.0423 17.28Z"
                      fill="#1D1C1D"
                    ></path>
                    <path
                      d="M30.0423 24.2824H15.1341C14.3435 24.2824 13.7788 24.96 13.7788 25.6376C13.7788 26.3153 14.4565 26.9929 15.1341 26.9929H30.0423C30.8329 26.9929 31.3976 26.3153 31.3976 25.6376C31.3976 24.96 30.8329 24.2824 30.0423 24.2824Z"
                      fill="#1D1C1D"
                    ></path>
                    <path
                      d="M30.0423 31.1718H15.1341C14.3435 31.1718 13.7788 31.8494 13.7788 32.5271C13.7788 33.2047 14.4565 33.8824 15.1341 33.8824H30.0423C30.8329 33.8824 31.3976 33.2047 31.3976 32.5271C31.3976 31.8494 30.8329 31.1718 30.0423 31.1718Z"
                      fill="#1D1C1D"
                    ></path>
                  </svg>
                  <h3 className="heading-3 heading-3--black">
                  ...
                  <p className="text text--black">
                    Integrate your third party tools with Slack to bring your
                    to-do list, your team and all your work talk together.
                  </p>
                </div>
              </div>
            </section>
        ...
        <div className="u-bg-white">
          <div className="u-max-width-85">
            <section className={sectionCompanies}>
              <h2 className="heading-2 heading-2--black u-mb-md u-mt-md u-pt-lg u-text-center">
        ...
        <section className={sectionTalk}>
          <h1 className="heading-1 heading-1--white">
            Choose a better way to work
          </h1>
          <div>
            <button className="btn btn--lg btn--white-contained u-mr-sm">
              Try Slack
            </button>
            <button className="btn btn--lg btn--white-outlined">
              Talk to Sales
            </button>
          </div>
        </section>
